...
foco de riesgo ambiental, donde los contaminantes históricos
...
Evaluar el impacto de la contaminación atmosférica por combustibles fósiles a través 
del fraccionamiento isotópico de $\delta^{18}$O y $\delta^{2}$D en el vapor de agua atmosférico.
